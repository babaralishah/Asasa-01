(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppPipesTableFilterPipeTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TableFilterPipe = /*#__PURE__*/function () {
        ...
        _createClass(TableFilterPipe, [{
          key: "transform",
          value: function transform(user, search_id) {
            if (!user || !search_id) {
              return user;
            }

            return user.filter(function (user) {
              return user.Id.toLowerCase().indexOf(search_id.toLowerCase()) !== -1;
            }); // if (!user) return [];
    ...
    function srcAppPipesTableFilter02PipeTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TableFilter02Pipe = /*#__PURE__*/function () {
        ...
        _createClass(TableFilter02Pipe, [{
          key: "transform",
          value: function transform(user, search_location) {
    ...
    function srcAppPipesTableFilter04PipeTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TableFilter04Pipe = /*#__PURE__*/function () {
        ...
        _createClass(TableFilter04Pipe, [{
          key: "transform",
          value: function transform(user, search_type) {
            if (!user || !search_type) {
              return user;
            }

            return user.filter(function (user) {
              return user.Type.toLowerCase().indexOf(search_type.toLowerCase()) !== -1;
            });
          }
        }]);
    ...
    function srcAppPipesTableFilter06PipeTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TableFilter06Pipe = /*#__PURE__*/function () {
        ...
        _createClass(TableFilter06Pipe, [{
          key: "transform",
          value: function transform(user, search_client) {
            if (!user || !search_client) {
              return user;
            }

            return user.filter(function (user) {
              return user.Client.toLowerCase().indexOf(search_client.toLowerCase()) !== -1;
            });
          }
        }]);
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! ./dashboard/options/options.component */
      "./src/app/dashboard/options/options.component.ts"); // import {MaterialModule} from '@angular/material';
    ...
    function srcAppDashboardUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @angular/common */
      "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js"); // import { Users } from './Users';
      ...
      UsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 41,
        vars: 2,
        consts: [[1, "users"], [1, "btn", "btn-primary", "rounded-pill"], [1, "pull-right"], [1, "card-body", "row"], [1, "col-auto"], [1, "fa", "fa-search", "icon"], [1, "col"], ["type", "search", "placeholder", "Search topics or keywords", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-primary", "rounded-pill"], [1, "table", "table-hover", "table-dark"], ["scope", "col"], [4, "ngFor", "ngForOf"], [1, "fa", "fa-edit", "icon"], ["role", "button"], [1, "fa", "fa-trash", "icon"]],
        template: function UsersComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "\xA0\xA0\xA0\xA0\xA0Users");
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"]],
        ...
        _createClass(ForgetpassComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.authServ.verifyEmail(body).subscribe(function (data) {
              ...
              var msg = data.status;
              var email = _this3.forgetPassForm.value.email;

              if (status) {
                alert(msg);

                _this3.router.navigate(['forgetpassverify-component', email]);
              } else {
                alert(msg);
              }
            });
      ...
      var ForgetpassverifyComponent = /*#__PURE__*/function () {
        ...
        _createClass(ForgetpassverifyComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (param) {
              _this4.email = param.email; // console.log(this.email);
            });
            this.initialize();
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            this.authServ.verifyOTPCode(user).subscribe(function (data) {
              ...
              if (status) {
                ...
                _this5.router.navigate(['newpass-component', _this5.email]);
              } else {
                alert(msg);
              }
            });
      ...
      var LoginComponent = /*#__PURE__*/function () {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (param) {
              _this6.email = param.email; // console.log(this.email);
            });
          ...
          value: function loginUser() {
            ...
            this.authService.login(this.loginForm.value).subscribe(function (data) {
              ...
              var email = _this7.loginForm.value.email; // const email = this.email;

              if (success) {
                console.log(_this7.email);
                console.log(email);
                alert('SUCCESS!! :-)');

                _this7.router.navigate(['profile', email]);
              } else {
        ...
        _createClass(MapComponent, [{
          ...
          value: function initializemapbox() {
            ...
            this.mapArray.forEach(function (marker) {
              ...
              new mapbox_gl__WEBPACK_IMPORTED_MODULE_1__["Marker"](el).setLngLat([marker.lat, marker.lng]).setPopup(new mapbox_gl__WEBPACK_IMPORTED_MODULE_1__["Popup"]().setHTML(marker.tag)).addTo(_this8.map);
            }); // this.map.addSource
          ...
          value: function mapboxOverlay() {
            ...
            this.map.on('load', function () {
              ...
              _this9.map.addSource('myImageSource', {
                type: 'image',
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this9.map.setPaintProperty('myImageSource', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this9.map.setPaintProperty('f-7', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this9.map.setPaintProperty('phase-2', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this9.map.setPaintProperty('e-16', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this9.map.setPaintProperty('e-18', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this9.map.setPaintProperty('enclave', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
          ...
          value: function onSubmit() {
            ...
            this.authServ.newpassword(user).subscribe(function (data) {
              ...
              if (status) {
                ...
                _this11.router.navigate(['login-component']);
              } else {
                alert(msg);
              }
            });
        ...
        _createClass(SignupComponent, [{
          ...
          value: function registerUser() {
            ...
            this.authService.register(this.registerForm.value).subscribe(function (data) {
              ...
              var email = _this12.registerForm.value.email;
              var msg = data.msg;
              ...
              if (status) {
                ...
                _this12.router.navigate(['signupotp-component', email]);
              } else {
                alert(msg);
              }
            });
      ...
      var SignupotpComponent = /*#__PURE__*/function () {
        ...
        _createClass(SignupotpComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (param) {
              _this13.email = param.email; // console.log(this.email);
            });
            this.initialize();
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            this.authServ.verifyOTPEmail(user).subscribe(function (data) {
              ...
              if (status) {
                ...
                _this14.router.navigate(['profile', _this14.email]);
              } else {
                alert(msg);
              }
            });
