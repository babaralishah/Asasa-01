(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function AppComponent_div_70_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AppComponent_div_75_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function AppComponent_div_75_div_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AppComponent_Template_form_ngSubmit_65_listener() {
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! ./dashboard/inactive/inactive.component */
      "./src/app/dashboard/inactive/inactive.component.ts"); // import {MaterialModule} from '@angular/material';
    ...
    function srcAppDashboardInactiveInactiveComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      InactiveComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 86,
        vars: 28,
        consts: [[1, "inactive"], [1, "pull-right"], [1, "card-body", "row"], [1, "col-auto"], [1, "fa", "fa-search", "icon"], [1, "col"], ["id", "myInput", "type", "text", "placeholder", "Search topic or keyword", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "btn", "btn-primary", "rounded-pill"], [1, "table", "table-hover", "table-dark"], ["scope", "col"], ["id", "myInput", "type", "text", "placeholder", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["id", "myInput", "type", "text", "placeholder", "", 1, "form-control"], [4, "ngFor", "ngForOf"], [1, "fa", "fa-edit", "icon"], ["role", "button"], [1, "fa", "fa-trash", "icon"]],
        ...
        _createClass(ForgetpassComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.authServ.verifyEmail(body).subscribe(function (data) {
              ...
              var msg = data.status;
              var email = _this2.forgetPassForm.value.email;

              if (status) {
                alert(msg);

                _this2.router.navigate(['forgetpassverify-component', email]);
              } else {
                alert(msg);
              }
            });
      ...
      var ForgetpassverifyComponent = /*#__PURE__*/function () {
        ...
        _createClass(ForgetpassverifyComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (param) {
              _this3.email = param.email; // console.log(this.email);
            });
            this.initialize();
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            this.authServ.verifyOTPCode(user).subscribe(function (data) {
              ...
              if (status) {
                ...
                _this4.router.navigate(['newpass-component', _this4.email]);
              } else {
                alert(msg);
              }
            });
        ...
        _createClass(LoginComponent, [{
          ...
          value: function loginUser() {
            ...
            this.authService.login(this.loginForm.value).subscribe(function (data) {
              ...
              var email = _this5.loginForm.value.email;

              if (success) {
                alert('SUCCESS!! :-)');

                _this5.router.navigate(['profile', email]);
              } else {
                alert('Invalid email or password!');
        ...
        _createClass(MapComponent, [{
          ...
          value: function initializemapbox() {
            ...
            this.mapArray.forEach(function (marker) {
              ...
              new mapbox_gl__WEBPACK_IMPORTED_MODULE_1__["Marker"](el).setLngLat([marker.lat, marker.lng]).setPopup(new mapbox_gl__WEBPACK_IMPORTED_MODULE_1__["Popup"]().setHTML(marker.tag)).addTo(_this6.map);
            }); // this.map.addSource
          ...
          value: function mapboxOverlay() {
            ...
            this.map.on('load', function () {
              ...
              _this7.map.addSource('myImageSource', {
                type: 'image',
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this7.map.setPaintProperty('myImageSource', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this7.map.setPaintProperty('f-7', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this7.map.setPaintProperty('phase-2', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this7.map.setPaintProperty('e-16', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this7.map.setPaintProperty('e-18', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
            ...
            this.map.on('load', function () {
              ...
              slider.addEventListener('input', function (e) {
                ...
                _this7.map.setPaintProperty('enclave', 'raster-opacity', parseInt('' + input + '', 10) / 100); // Value indicator
          ...
          value: function onSubmit() {
            ...
            this.authServ.newpassword(user).subscribe(function (data) {
              ...
              if (status) {
                ...
                _this9.router.navigate(['login-component']);
              } else {
                alert(msg);
              }
            });
        ...
        _createClass(SignupComponent, [{
          ...
          value: function registerUser() {
            ...
            this.authService.register(this.registerForm.value).subscribe(function (data) {
              ...
              var email = _this10.registerForm.value.email;
              var msg = data.msg;
              ...
              if (status) {
                ...
                _this10.router.navigate(['signupotp-component', email]);
              } else {
                alert(msg);
              }
            });
